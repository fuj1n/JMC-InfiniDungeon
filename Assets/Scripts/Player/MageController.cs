public class MageController : PlayerControllerBase
{
    protected override void FillSpells()
    {
        ...
        spells.Add(new SpellAttack(5, 0F, 2F).SetDamage(5F).SetPrimaryStat(PlayerData.Stats.Stat.INTELLIGENCE).SetFlySpeed(25F).SetIcon("Weapon_20").SetAnimation("Cast", false).SetParticle("Fire"));
        ...
        spells.Add(new SpellHeal(3, 5F, 30F).SetHealingPotential(.5F).SetIcon("Weapon_16").SetAnimation("Heal").SetParticle("Heal"));
    }
}
