public class MageController : PlayerControllerBase
{
    ...
    {
        spells.Add(new SpellAttack(1, 2F, 0F).SetDamage(10F).SetPrimaryStat(PlayerData.Stats.Stat.INTELLIGENCE).SetIcon("Weapon_19").SetAnimation("Cast").SetParticle("Fire"));
        ...
        spells.Add(new SpellAttack(10, 5F, 0F).SetDamage(30F).SetPrimaryStat(PlayerData.Stats.Stat.INTELLIGENCE).SetIcon("Weapon_17").SetAnimation("Cast").SetParticle("Fire"));
